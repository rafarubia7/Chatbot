...
RESPOSTAS_PADRAO = {
    ...
    "erro_geral": (
        ...
        "Sou o Cadu, assistente virtual do SenAI, ferramenta de auxilio para o SENAI São Carlos. "
        "Se sua pergunta for sobre a unidade, por favor inclua mais contexto (curso, horário, secretaria, biblioteca, salas etc.) e tente novamente.\n\n"
        "(As informações deste chat são baseadas no site oficial https://sp.senai.br/unidade/saocarlos/ e na equipe gestora. Para mais informações, consulte os canais oficiais.)"
    ),
